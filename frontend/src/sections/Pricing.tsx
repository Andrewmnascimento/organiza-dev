export const Pricing = () => {
  return (
    <section id="pricing" className="flex flex-col items-center py-24 px-8 bg-zinc-100">
      ...
      <div className="flex flex-row justify-between items-center w-max gap-16 p-20  ">
        <div className="flex flex-col bg-white rounded-2xl p-8  gap-4 w-64">
          ...
          <p className="text-4xl font-semibold">$0<span className="text-lg font-normal text-zinc-500">/mo</span></p>
